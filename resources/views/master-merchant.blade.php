...
<body class="direction-ltr " dir="ltr">
    ...
    <body class="direction-rtl " dir="rtl">
        ...
        <div class="main-container">
            ...
            @include('web/merchants/header')
            @include('web/merchants/sidebar')
        ...
        <div class="dashboard-footer">&copy; {{date('Y')}} {{ __('messages.title') }}. {{ __('messages.All_rights_reserved') }}</div>
...
@yield('scripts')
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDHKgO_ANzKuSjQCQxwEx2bYlbmxBu_F5U&callback=initAutocomplete&libraries=places&v=weekly" defer></script>
