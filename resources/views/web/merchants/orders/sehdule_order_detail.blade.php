...
<div class="main-heading-container">
    <div class="common-title">{{ __('messages.Schedule') }} {{ __('messages.Orders') }}</div>
    <a href="{{ url('/merchant/sehdule-orders/list') }}" class="btn btn-primary w-170">{{ __('messages.Back') }}</a>
</div>
<div class="row mb-4">
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">{{ __('messages.Schedule') }} {{ __('messages.Orders') }} {{ __('messages.Detail') }}</div>
            </div>
