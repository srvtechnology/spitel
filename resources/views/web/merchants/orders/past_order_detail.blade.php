...
<div class="main-heading-container">
    ...
    <a href="{{ url('/merchant/past-orders/list') }}" class="btn btn-primary w-170">{{ __('messages.Back') }}</a>
</div>
<div class="row mb-4">
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">{{ __('messages.Past') }} {{ __('messages.Orders') }} {{ __('messages.Detail') }}</div>
            </div>
