...
@section('content')
    <div class="main-heading-container">
        ...
        <a href="{{ url('/merchant/menucategories/add') }}" class="btn btn-primary w-170">{{ __('messages.Add') }}</a>
    </div>
    <div class="row mb-4 total-sale-wraper total-many-wrapper ordersAll">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg">
            <div class="total-info-card">
                ...
                <div class="total-info-card-detail">
                    <div class="total-info-card-title">{{ __('messages.All') }} {{ __('messages.Active') }}</div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg">
            <div class="total-info-card">
                ...
                <div class="total-info-card-detail">
                    <div class="total-info-card-title">{{ __('messages.All') }} {{ __('messages.Inactive') }}</div>
        ...
        <div class="col-lg-12">
            <div class="card-common">
                <div class="card-topbar-inner">
                    <div class="card-topbar-title">{{ __('messages.All') }} {{ __('messages.Menu_Categories') }}</div>
                </div>
                                ...
                                <div class="filters-table">
                                    <div class="main-filters">
                                        <input type="text" class="form-control form-control-filters"
                                            placeholder="{{ __('messages.System_ID') }}">
                                        {{-- <input type="text" class="form-control form-control-filters"
                        ...
                        <table id="customers" class="table tableCommon table-striped table-single-line">
                            ...
                            <tbody> 
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions-col">
                                            {{-- <a class="actionIcon" href="{{ url('/merchant/menucategories/view') }}">
                                                <span>{{ __('messages.View') }}</span>
                                                <i class="fa-solid fa-eye textOrange"></i>
                                            </a> --}}
                                            <a class="actionIcon" href="{{ url('/merchant/menucategories/edit') }}">
                                            ...
                                            <a class="actionIcon"href="#myModal" class="trigger-btn" data-toggle="modal"> 
                                                <span>{{ __('messages.Categories') }} {{ __('messages.Delete') }}</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group dropdown-menu-action-active-group">
                                            <div class="status-common status-red dropdown-toggle"
                                                data-bs-toggle="dropdown" aria-expanded="false">
