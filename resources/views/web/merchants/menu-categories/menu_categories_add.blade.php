...
<div class="main-heading-container">
    ...
    <a href="{{ url('/merchant/menucategories/list') }}" class="btn btn-primary w-170">{{ __('messages.Back') }}</a>
</div>

<form action="{{route('save-merchant-menu-cat')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control" name="status">
                                <option value="" selected disabled>{{ __('messages.Select_Status') }}</option>
