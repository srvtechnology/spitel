...
<div class="main-heading-container">
    ...
    <a href="{{ url('/merchant/hours-add') }}" class="btn btn-primary w-170">{{ __('messages.Add') }}</a>
</div>
<div class="row mb-4">
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">{{ __('messages.All') }} {{ __('messages.Working_Hours') }}</div>
            </div>
                        ...
                        <div class="filters-table-wrapper">
                            ...
                            <div class="filters-table">
                                <div class="main-filters">
                                    ...
                                    <input type="text" class="form-control form-control-filters" placeholder="{{ __('messages.Day') }}">
                    ...
                    <table id="customers" class="table tableCommon table-striped table-single-line">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('messages.Opening_Time') }}</th>
                                <th>{{ __('messages.Closing_Time') }}</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions-col">
                                        <a class="actionIcon" href="{{ url('/merchant/hours-view') }}">
                                            <span>{{ __('messages.View') }} {{ __('messages.Notification') }}</span>
                                            <i class="fa-solid fa-eye textOrange"></i>
                                        </a>
                                        <a class="actionIcon" href="{{ url('/merchant/hours-edit') }}">
                                            <span>{{ __('messages.Working_Hours') }} {{ __('messages.Edit') }}</span>
                                        ...
                                        <a class="actionIcon" href="#myModal" class="trigger-btn" data-toggle="modal">
                                            <span>{{ __('messages.Working_Hours') }} {{ __('messages.Delete') }}</span>
