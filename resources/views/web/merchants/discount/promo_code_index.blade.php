...
<div class="main-heading-container">
    ...
    <a href="{{ url('/merchant/promo-code/add') }}" class="btn btn-primary w-170">{{ __('messages.Add_Promo_Code') }}</a>
</div>
    ...
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">All Promo Code</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions-col">
                                        <a class="actionIcon" href="{{ url('/merchant/promo-code/view') }}">
                                            <span>{{ __('messages.View') }} {{ __('messages.Detail') }}</span>
                                            <i class="fa-solid fa-eye textOrange"></i>
                                        </a>
                                        <a class="actionIcon" href="{{ url('/merchant/promo-code/edit') }}">
