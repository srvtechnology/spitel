...
<div class="main-heading-container">
    ...
    <div class="btns">
        ...
        <a href="{{ url('/merchant/menu-item/addon-category-add') }}" class="btn btn-primary w-170">{{ __('messages.Add') }}</a>
    </div>
</div>
<div class="row mb-4">
    <div class="col-lg-12">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions-col">
                                        <a class="actionIcon" href="{{ url('/merchant/menu-item/add-on-option') }}">
                                            <!-- item category (add-on options)  -->
                                            <span>{{ __('messages.View_Extras_Menu_Options') }}</span>
                                            <i class="fa-solid fa-eye textOrange"></i>
                                        </a>
                                        <a class="actionIcon" href="{{ url('/merchant/menu-item/addon-category-edit') }}">
