...
<div class="main-heading-container">
    ...
    <a href="{{ url('/merchant/menu-item/add-on-option') }}" class="btn btn-primary w-170">{{ __('messages.Back') }}</a>
</div>
        ...
        <div class="col-lg-12">
            <div class="card-common">
                <div class="card-topbar-inner">
                    <div class="card-topbar-title">{{ __('messages.Add_Extras_Menu_Options') }}</div>
                </div>
                <div class="card-common-body">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>{{ __('messages.Addon_Name') }} (English)</label>
                            <input type="text" name="product_name" value="" class="form-control" placeholder="{{ __('messages.Addon Name') }}">
                        </div>
                        <div class="col-md-6 form-group">
