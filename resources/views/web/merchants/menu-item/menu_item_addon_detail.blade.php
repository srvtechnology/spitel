...
<div class="main-heading-container">
    ...
    <div>
        <a href="{{ url('/merchant/menu-item/view') }}" class="btn btn-primary w-170">{{ __('messages.Back') }}</a>
        <a href="{{ url('/merchant/menu-item/addon-option-add') }}" class="btn btn-primary w-170">{{ __('messages.Add') }}</a>
    </div>
</div>
<div class="row mb-4">
    <div class="col-lg-12">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions-col">
                                        ...
                                        <a class="actionIcon" href="{{ url('/merchant/menu-item/addon-option-edit') }}">
