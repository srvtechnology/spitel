                    ...
                    <div class="login-wrapper">
                        ...
                        <form action="{{route('merchant.resetPassword')}}" method="POST">
                            ...
                            <div class="form-group log-form-fields">
                                ...
                                <input type="email" required class="form-control" name="email" id="" placeholder="{{ __('messages.Place_email') }}">
                            </div>

                            <!-- <button class="btn btn-primary btn-login btn-full">Login</button> -->
                            <button type="submit" class="btn btn-primary btn-login btn-full">{{ __('messages.Reset_Password') }}</a>
                            <div class="forget-link">
                                <a href="{{url('/merchant')}}">{{ __('messages.Back_to_Login') }}</a>
                            </div>
                        </form>
