...
<div class="main-heading-container">
    ...
    <div class="btns">
        <a href="{{ url('/representative/menu-item/list') }}" class="btn btn-primary w-170">{{ __('messages.Back') }}</a>
        <a href="{{ url('/representative/menu-item/addon-category-add') }}" class="btn btn-primary w-170">{{ __('messages.Add') }}</a>
    </div>
</div>
<div class="row mb-4">
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">{{ __('messages.All_Extra_Options_Menu_Category') }}</div>
            </div>
                    ...
                    <table class="customers table tableCommon table-striped table-single-line">
                        <thead>
                            <tr>
                                ...
                                <th>{{ __('messages.Selection_Status') }}</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions-col">
                                        <a class="actionIcon" href="{{ url('/representative/menu-item/add-on-option') }}">
                                            <!-- item category (add-on options)  -->
                                            <span>{{ __('messages.View_Extras_Menu_Options') }}</span>
                                            <i class="fa-solid fa-eye textOrange"></i>
                                        </a>
                                        <a class="actionIcon" href="{{ url('/representative/menu-item/addon-category-edit') }}">
