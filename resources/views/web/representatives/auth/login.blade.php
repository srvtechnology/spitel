            ...
            <div class="login-main-container">
                <div class="login-wrapper">
                    ...
                    <div class="login-heading">
                        {{ __('messages.Welcome_representative') }}
                    </div>
                    <div class="login-text">
                        {{ __('messages.Welcome_Merchant_text') }}
                    </div>
                    <form action="{{route('representative.login')}}" method="POST">
                        @csrf
                        ...
                        <button type="submit"
                            class="btn btn-primary btn-login btn-full">{{ __('messages.login') }}</button>
                        <div class="forget-link">
                            <a
                                href="{{ url('/representative/reset-password') }}">{{ __('messages.Forgot_Password') }}</a>
                        </div>
                    </form>
                </div>
                <div class="logo_icon">
