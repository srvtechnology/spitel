<header id="page-topbar">
    ...
    <div class="navbar-header">
        ...
        <div class="top-bar-sets">
            ...
            <div class="btn-group">
                ...
                @if (app()->getLocale() === 'en')
                    <a href="{{ route('setLocale', 'ar') }}"
                        ...
                        <img class="flag-icon-squared" src="{{ asset('assets/admin/flags/langIcon/sa.svg') }}"
                            alt="">
                        AR</a>
                @else
                    <a href="{{ route('setLocale', 'en') }} "
                        class="btn-flag btn-primary Banner-btn text-regular btn_respon select-lang-eng">
                        <img class="flag-icon-squared" src="{{ asset('assets/admin/flags/langIcon/au.svg') }}"
                            alt="">
                        ENG </a>
                @endif
            ...
            <div class="btn-group">
                <div class="top-bar-avatar dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><img
                        src="{{ asset('assets/admin/images/avatar.png') }}"></div>
                ...
                <ul class="dropdown-menu dropdown-menu-avatar">
                    ...
                    <li><a class="dropdown-item"
                            href="{{ url('/representative/profile') }}">{{ __('messages.Admin') }}</a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><a class="dropdown-item"
                            href="{{ route('representative.logOut') }}">{{ __('messages.logout') }}</a>
                </ul>
            </div>
        </div>
    </div>
