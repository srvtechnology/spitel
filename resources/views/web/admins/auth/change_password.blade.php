                ...
                <div class="login-wrapper ">
                    ...
                    <form action="" method="POST">
                        <div class="form-group log-form-fields">
                            ...
                            <input type="password" required class="form-control" name="oldpassword" id=""
                        ...
                        <div class="form-group log-form-fields">
                            ...
                            <input type="password" required class="form-control" name="newpassword" id=""
                        ...
                        <div class="form-group log-form-fields">
                            ...
                            <input type="password" required class="form-control" name="confirmpassword" id=""
                                placeholder="{{ __('messages.Confirm_Password') }}">
                        </div>

                        <button type="submit"
                            class="btn btn-primary btn-login btn-full">{{ __('messages.Submit') }}</a>
                    </form>
                </div>
            </div>
            <div class="logo_icon">
