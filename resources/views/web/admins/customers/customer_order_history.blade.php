...
<div class="main-heading-container">
    <div class="common-title">{{ __('messages.Customer') }} {{ __('messages.Order_History') }}</div>
    <a href="{{ url('/admin/customers/list') }}" class="btn btn-primary w-170">{{ __('messages.Back') }}</a>
</div>
<div class="row mb-4">
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">{{ __('messages.Customer') }} {{ __('messages.Order_History') }}</div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions-col">
                                        <a class="actionIcon" href="{{ url('/admin/customer-order-history-detail') }}">
