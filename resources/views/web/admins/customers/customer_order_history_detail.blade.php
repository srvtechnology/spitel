...
<div class="main-heading-container">
    <div class="common-title">{{ __('messages.Order_History') }}</div>
    <a href="{{ url('/admin/customer-order-history') }}" class="btn btn-primary w-170">Back</a>
</div>
<div class="row mb-4">
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">{{ __('messages.Order_History') }} {{ __('messages.Detail') }}</div>
            </div>
            <div class="card-common-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6 form-group col-detail-view">
                        <div class="label-heading"> {{ __('messages.Number') }}</div>
                        <div class="label-txt"><a class="primaryLink" href="#!" target="_blank">Customer Number</a></div>
                    </div>
                    <!-- <div class="col-md-12 col-lg-6 form-group col-detail-view">
                            <div class="label-heading">Provider Name</div>
