...
<div class="main-heading-container">
    <div class="common-title">{{ __('messages.Past') }} {{ __('messages.Orders') }}</div>
</div>
<div class="row mb-4">
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">{{ __('messages.All') }} {{ __('messages.Past') }} {{ __('messages.Orders') }}</div>
            </div>
                    ...
                    <table id="customers" class="table tableCommon table-striped table-single-line">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a class="primaryLink" href="#!" target="_blank">Arham</a></td>
                                <td>type</td>
                                <td>4:20 pm</td>
                                <td>5:00 pm</td>
                                <td>
                                ...
                                <td>
                                    <div class="actions-col">
                                        <a class="actionIcon" href="{{ url('/admin/past-order-detail') }}">
