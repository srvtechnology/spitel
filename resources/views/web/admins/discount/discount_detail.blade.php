...
<div class="main-heading-container">
    <div class="common-title">{{ __('messages.Discount') }}</div>
    <a href="{{ url('/admin/discount/list') }}" type="submit" class="btn btn-primary w-170">{{ __('messages.Back') }}</a>
</div>
    ...
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">{{ __('messages.Discount') }} {{ __('messages.Detail') }}</div>
            </div>
            ...
            <div class="card-common-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6 form-group col-detail-view">
                        <div class="label-heading">{{ __('messages.Discount') }} {{ __('messages.Title') }}(Arabic)</div>
                        <div class="label-txt">Discount Title</div>
                    </div>
                    <div class="col-md-12 col-lg-6 form-group col-detail-view">
                        <div class="label-heading">{{ __('messages.Discount') }} {{ __('messages.Title') }}(English)</div>
                        <div class="label-txt">Discount Title</div>
                    </div>
                    <div class="col-md-12 col-lg-6 form-group col-detail-view">
