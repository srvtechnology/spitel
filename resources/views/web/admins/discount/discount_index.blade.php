...
<div class="main-heading-container">
    <div class="common-title">{{ __('messages.Discounts') }}</div>
    <div class="btns">
    ...
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">{{ __('messages.All') }} {{ __('messages.Discounts') }}</div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions-col">
                                        <a class="actionIcon" href="{{ url('/admin/discount/view') }}">
