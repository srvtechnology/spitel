...
@section('content')
    <div class="main-heading-container">
        ...
        <a href="{{ url('/admin/store-categories/add') }}" class="btn btn-primary w-170">{{ __('messages.Add') }}</a>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card-common">
                <div class="card-topbar-inner">
                    <div class="card-topbar-title">{{ __('messages.All_Food_Categories') }}</div>
                            ...
                            <div class="col-md-12">
                                <div class="filters-table-wrapper">
                                    ...
                                    <div class="filters-table">
                                        <div class="main-filters">
                                            <input type="text" class="form-control form-control-filters"
                                                value="{{ request('id') }}" name="id" placeholder="System ID">
                                            <input type="text" class="form-control form-control-filters"
                                                value="{{ request('name') }}" name="name" placeholder="Category Name">
                                            <select class="form-control form-control-filters"
                                                value="{{ request('status') }}" name="status">
                                    ...
                                    <div class="filters-control">
                                        <a href="{{ url('admin/store-categories/list') }}"
                                        ...
                                        <td>
                                            <div class="btn-group dropdown-menu-action-active-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-action dropdown-menu-action-active"
                                                    id="category_id">
                                                    <li value="{{ $merchant_category->id }}" data="1">
                                                        <a class="dropdown-item active"
                                                            href="#!">{{ __('messages.Active') }}</a>
                                                    </li>
                                                    <li>
