...
@section('content')
    ...
    <form action="{{ route('merchant.update', $merchant_categry->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row mb-4">
            <div class="col-lg-12">
                <div class="card-common">
                    <div class="card-topbar-inner">
                        <div class="card-topbar-title">{{ __('messages.Edit') }} {{ __('messages.Food Categories') }}</div>
                    </div>
                    ...
                    <div class="card-common-body">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="name_eng" value="{{ $merchant_categry->name_eng }}"
                                    class="form-control" placeholder="{{ __('messages.Category_Name') }}">
                                @error('name_eng')
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="name_arabic" value="{{ $merchant_categry->name_arabic }}"
                                    class="form-control" placeholder="{{ __('messages.Category_Name') }}">
                                @error('name_arabic')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select class="form-control" name="status">
                                    ...
                                    <option value="1" @selected($merchant_categry->status == 1)>{{ __('messages.Active') }}
                                    </option>
                                    <option value="2" @selected($merchant_categry->status == 1)2>{{ __('messages.Inactive') }}
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-6 form-group">
