        ...
        <div class="col-md-6 col-8 align-self-center">
            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('profile.view') }}">View profile</a></li>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-3 avtar-container">
                    <div class="col-md-4">
                        <img src="{{ $profile->avtar }}" alt="Avtar" class="img-fluid img-thumbnail" id="avtar-preview">
                         <form action="{{ route('profile.approved') }}" method="post" id="customer_action_form">
                            @csrf
