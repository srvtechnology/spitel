...
@section('title')Admin - Blood Group @endsection
@section('styles')
...
<div class="page-breadcrumb">
    <div class="row align-items-center">
        <div class="col-md-6 col-8 align-self-center">
            <h3 class="page-title mb-0 p-0">Blood Group</h3>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="align-right">
                            <div class="text-end upgrade-btn mb-3">
                                <a href="javascript:void(0)" class="btn btn-success link-btn add-native-place">+ Add Blood Group</a>
                            </div>
                        </div>
                        @endif
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class='action'>
                                        ...
                                        <a href="{{ url('/admin/manage/delete/blood-group/'.$row->id) }}" onclick='return confirm("Are you sure?")'><i class='fa-solid fa-trash text-danger'></i></a>&nbsp;
                                        @endif
                                    </span>
                                </td>
                            </tr>
                    ...
                    <div class="d-flex justify-content-center" id="laravel_pagination">
                        {{ $blood_groups->appends(request()->query())->links() }}
                    </div>
                </div>
            </div>
        </form>
...
<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <form action="{{route('manage.blood_group.store')}}" method="post">
        @csrf
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add/edit Blood Group</h5>
...
<script>
    $(document).ready(function(){
        ...
        $(".blood-group-link").addClass('active');
        ...
        $("#custom_search").on("keyup", function () {
            ...
            $.ajax({
                url: "{{ route('manage.blood_group.ajax_search') }}",
                method: "POST",
                data: {
                    _token : "{{ csrf_token() }}",
                    search: search_title
        ...
        var table = $('.surname-datatable').DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "{{ route('manage.blood_group.list') }}"
            },
            columns: [
                {
