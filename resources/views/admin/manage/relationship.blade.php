            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class='action'>
                                        ...
                                        <a href="{{ url('/admin/manage/delete/relationship/'.$row->id) }}" onclick='return confirm("Are you sure?")'><i class='fa-solid fa-trash text-danger'></i></a>&nbsp;
                                        @endif
                                    </span>
                                </td>
                            </tr>
                    ...
                    <div class="d-flex justify-content-center" id="laravel_pagination">
                        {{ $relationship->appends(request()->query())->links() }}
                    </div>
                </div>
            </div>
        </form>
...
<script>
    $(document).ready(function(){
        ...
        $("#custom_search").on("keyup", function () {
            ...
            $.ajax({
                url: "{{ route('manage.relationship.ajax_search') }}",
                method: "POST",
                data: {
                    _token : "{{ csrf_token() }}",
                    search: search_title
