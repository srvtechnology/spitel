...
@section('title')Admin - Panth @endsection
@section('styles')
...
<div class="page-breadcrumb">
    <div class="row align-items-center">
        <div class="col-md-6 col-8 align-self-center">
            <h3 class="page-title mb-0 p-0">Panth</h3>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item"><a href="#">Manage</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Panth</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="align-right">
                            <div class="text-end upgrade-btn mb-3">
                                <a href="javascript:void(0)" class="btn btn-success link-btn add-native-place">+ Add Panth</a>
                            </div>
                        </div>
                        @endif
                    </div>
                    ...
                    <div class="d-flex justify-content-center" id="laravel_pagination">
                        {{ $panth->appends(request()->query())->links() }}
                    </div>
                </div>
            </div>
        </form>
...
<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <form action="{{route('manage.panth.store')}}" method="post">
        @csrf
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add/edit Panth</h5>
...
<script>
    $(document).ready(function(){
        ...
        $("#custom_search").on("keyup", function () {
            ...
            $.ajax({
                url: "{{ route('manage.panth.ajax_search') }}",
                method: "POST",
                data: {
                    _token : "{{ csrf_token() }}",
                    search: search_title
